...
# bicycle doesn't have Number of transport and Power of Engine,
# so we write "None" because class Motorbike inherit from class Bicycle and have both parameters
